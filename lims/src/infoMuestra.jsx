...
export default function InfoMuestra(){
    return (
        ...
        rows={4} />
              ...
              <Container maxWidth="md" sx={{border: 2, borderRadius: 3, padding: "5px 0"}}>                
                <div id="principalContainer">
                  <div id="sContainer">
                    ...
                    <FormControl id="datos" sx={{ width: '25ch' }}>
                      <TextField  disabled id="standard-disabled" label="Fuente de metodología analítica" defaultValue="xxxx" variant="standard" />
                    </FormControl>
                    <FormControl id="datos" sx={{ width: '25ch' }}>
                  ...
                  <div id="sContainer">
                    <FormControl id="datos" variant="standard" sx={{ width: '25ch' }}>
                      <TextField  disabled id="standard-disabled" label="Principio actual asignado" defaultValue="xxxx" variant="standard" />
                    </FormControl>
                    <FormControl id="datos" variant="standard" sx={{ width: '25ch' }}>
                      <TextField  disabled id="standard-disabled" label="Descripción" defaultValue="xxxx" variant="standard" />
                    </FormControl>
                    <FormControl id="datos" variant="standard" sx={{ width: '25ch' }}>
            ...
            <Button variant="contained" sx={{margin: 2, backgroundColor: "#12C2E9"}}>Enmendar</Button>
            <Button variant="contained" sx={{margin: 2, marginRight: 0, backgroundColor: "#12C2E9"}}>Auditar</Button>
            </Container>            
        </Container>
      );
    }