...
export default function ModalEditarAnalisis(){
    const [open, setOpen] = React.useState(false);
    const handleOpen = () => setOpen(true);
    const handleClose = () => setOpen(false);
  return (
    <div>
      <Button onClick={handleOpen} variant='contained' sx={{backgroundColor: "#12C2E9"}}>Editar análisis</Button>
      <Modal
                ...
                <div id="contenedorPrincipal">
                    <div className="sndContainer">
                        ...
                        <FormControl id="datos" variant="standard" sx={{ width: '25ch' }}>
                            <InputLabel id="demo-simple-select-standard-label">Forma farmacéutica</InputLabel>
                            <Select
